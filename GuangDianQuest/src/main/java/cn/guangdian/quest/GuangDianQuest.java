...
import cn.guangdian.quest.manager.QuestUnlockManager;
...
public class GuangDianQuest extends AbstractRPGPlugin {
    ...
    public Component getMessageComponent(String key, String... replacements) {
        ...
        return miniMessage(colorToString(msg));
    }
    ...
    public ChatMessageService getChatMessageService() { return chatMessageService; }
