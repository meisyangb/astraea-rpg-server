...
### 1. 主类优化 (GuangDianBoard.java)

#### 新增 RPGCore GameLogger 集成
- 添加 `GameLogger gameLogger` 字段
- 更新 `initRPGCoreServices()` 方法，添加 GameLogger 初始化
- 新增日志辅助方法：
...
- 更新类文档，添加 RPGCore 服务集成说明

### 2. 配置文件检查

配置文件 `config.yml` 已经使用 MiniMessage 格式：
- 标题: `'<white>Lv.<yellow>%player_level% <green>%player_name%'`
- 消息配置: `"<red>您没有权限执行此操作!"`
- 侧边栏内容: `'<green><underlined>﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏'`
- 无需修改
