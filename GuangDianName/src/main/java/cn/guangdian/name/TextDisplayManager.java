...
public class TextDisplayManager {
    ...
    private String getGuildName(Player player) {
        try {
            Plugin guildPlugin = Bukkit.getPluginManager().getPlugin("GuangDianGuild");
            if (guildPlugin == null) {
                return null;
            }

            Method getPlayerGuild = guildPlugin.getClass().getMethod("getPlayerGuild", String.class);
            Object guild = getPlayerGuild.invoke(guildPlugin, player.getName());
            if (guild == null) {
                return null;
            }

            Field nameField = guild.getClass().getField("name");
