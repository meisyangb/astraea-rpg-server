...
public class DecomposeRule {
    ...
    public static class TierRule {
        ...
        public TierRule(String name, String pattern) {
            this.name = name;
        ...
        public boolean matches(String loreText) {
            if (loreText == null || pattern == null) return false;
            return loreText.contains(pattern);
        }
    }
}
